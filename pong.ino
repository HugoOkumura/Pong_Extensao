 ...
 * 
*************************************************************/
void colisao_jogador(uint8_t circle_x, uint8_t circle_y){
...
void colisao_campo(uint8_t circle_x, uint8_t circle_y){
  //colisão em cima
  if(circle_y == 8){
  dir_y *= -1;
  }
...
void colisao_pontuacao(uint8_t circle_x, uint8_t circle_y){
...
void jogo(){
  ...
  // Desenha a posição do jogador 1
  x = analogRead(A0);
  ...
  // Desenha a posição do jogador 2
  x = analogRead(A1);
  x = map(x, 0, 1023, 20, 80);
  p2_cima = x+12;
  p2_baixo = x-12;
  ...
  colisao_jogador(circle_x, circle_y);
  colisao_campo(circle_x, circle_y);
  colisao_pontuacao(circle_x, circle_y);
}
